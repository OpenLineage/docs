...
This Ecosystem Survey, our first ever, is an effort to gauge how well we serving our partners and users and to gain a better understanding of your needs.

We plan to conduct a survey like this on an annual basis.

The questions focus on users':

- preferences for how we should prioritize supporting various tooling categories (e.g., orchestrators),
- preferences for how we should prioritize supporting specific tools in each category,
